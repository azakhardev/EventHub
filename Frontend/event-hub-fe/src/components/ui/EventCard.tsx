  ...
  return (
    <div
      className={combineString([
        "rounded-lg border-2 flex flex-row bg-card pr-4 overflow-hidden",
        props.className,
      ])}
    >
      <div
      ...
      <div className="flex flex-col gap-2 w-full">
        ...
        <div className="flex flex-row items-center justify-end">
          <div className="relative top-[-15px] font-bold">
            {event.owner.username}
          </div>
        </div>
      </div>
      {/* <div
        className="relative top-[-10px] right-[-130px] w-[150px] h-[150px] rotate-45 origin-top-right"
        style={{ backgroundColor: event.color }}
      /> */}
    </div>
  );
